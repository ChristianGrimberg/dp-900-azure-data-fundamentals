...
![Explorador de datos de Azure](img/azure-data-explorer.png) Azure Data Explorer es un servicio independiente que permite consultar datos de telemetría y de registros con el mismo rendimiento elevado que el _runtime_ de Azure Synapse Data Explorer en Azure Synapse Analytics.
